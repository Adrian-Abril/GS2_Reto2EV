...
.register {
  ...
  &__container {
    ...
    width: 100%;
    max-width: 500px; // Tamaño de la caja
    text-align: center;
  }
  ...
  &__label {
    ...
    width: 100%;
    max-width: 350px; // Alineado con los inputs
    text-align: left; // Asegura alineación con el input
  }

  &__input {
    width: 100%;
    max-width: 350px; // Tamaño estándar fijo
    padding: 0.8rem;
